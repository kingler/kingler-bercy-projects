...
/*    $('.cd-3d-nav-trigger').on('click', function(){
		toggle3dBlock(!$('.top-container').hasClass('nav-is-visible'));
	});*/
	...
	function toggle3dBlock(addOrRemove) {
		...
		$('.top-container').toggleClass('nav-is-visible', addOrRemove);
		$('.projects-container').toggleClass('nav-is-visible', addOrRemove);
	}
